...
_TOOL = {
    ...
    "input_schema": {
        ...
        "properties": {
            ...
            "features":        {"type": "array", "items": {"type": "string", "enum": ["balcony", "elevator", "parking", "garage", "fireplace", "child_friendly", "pets_allowed", "temporary", "new_build", "wheelchair_accessible", "private_laundry", "minergie_certified"]}},
